    ...
    public function index(): View
    {
        ...
        foreach ($students as $student) {
            $guidances = Guidance::where('student_id', $student->id)
                ...
                ->first();
            if ($guidances) {
                $studentThesisTitles[$student->id] = $guidances->thesis_title;
            } else {
                $studentThesisTitles[$student->id] = null;
            }
        }

        return view('dashboard.atur-jadwal-bimbingan.index', compact('students', 'studentThesisTitles'));
    }
