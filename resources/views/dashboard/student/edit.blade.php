        ...
        <form method="post" action="{{ route('dashboard.student.update', $student->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('fullname') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('fullname', $student->fullname) }}" autocomplete="name" autofocus required />
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control {{ $errors->get('nim') ? 'border-danger' : '' }}"
                    id="nim" name="nim" placeholder="NIM" value="{{ old('nim', $student->nim) }}"
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control {{ $errors->get('email') ? 'border-danger' : '' }}"
                    id="email" name="email" placeholder="Email" value="{{ old('email', $student->user->email) }}"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control {{ $errors->get('angkatan') ? 'border-danger' : '' }}"
                    id="angkatan" name="angkatan" placeholder="Angkatan" value="{{ old('angkatan', $student->batch) }}"
            ...
            <div class="mb-3">
                ...
                <x-select :options="$lecturers" key="fullname" placeholders="Pilih Dosen Pembimbing I" id="lecturer_id_1"
                    name="lecturer_id_1" :value="$student->lecturer_id_1" required />
            ...
            <div class="mb-3">
                ...
                <x-select :options="$lecturers" key="fullname" placeholders="Pilih Dosen Pembimbing II" id="lecturer_id_2"
                    name="lecturer_id_2" :value="$student->lecturer_id_2" required />
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control {{ $errors->get('no-hp') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('no-hp', $student->phone_number) }}" autocomplete="tel" />
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control {{ $errors->get('alamat') ? 'border-danger' : '' }}" id="alamat" name="alamat"
                    placeholder="Alamat" value="{{ old('alamat', $student->address) }}" rows="2"
                    autocomplete="address-level1">{{ old('alamat', $student->address) }}</textarea>
