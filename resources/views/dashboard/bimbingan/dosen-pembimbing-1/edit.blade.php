<x-dashboard-layout title="Request Bimbingan">
    ...
    <div class="card p-4">
        <form method="post" action="{{ route('dashboard.bimbingan-1.update', $bimbingan->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div>
                ...
                <a href="{{ route('dashboard.bimbingan-1.index') }}" class="btn btn-outline-secondary ms-2">Batal</a>
            </div>
        </form>
    </div>
