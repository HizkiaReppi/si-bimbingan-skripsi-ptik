    ...
    <div class="card">
        <div class="d-flex flex-column-reverse flex-md-row justify-content-between align-items-center">
            ...
            <div class="mt-2 mt-md-0 ms-3 mt-md-0 ">
                @if ($guidances)
                <a href="{{ route('dashboard.bimbingan-2.print') }}" class="btn btn-secondary me-2 mt-1">
                    <i class="fa fa-print me-2"></i>
                    Cetak Kartu Bimbingan
                </a>
                @endif
                <a href="{{ route('dashboard.bimbingan-2.create') }}" class="btn btn-primary me-4 mt-1">Request Bimbingan</a>
            </div>
        </div>
