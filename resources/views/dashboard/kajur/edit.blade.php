        ...
        <form method="POST" action="{{ route('dashboard.kajur.update', $kajur->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('fullname') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('fullname', $kajur->user->name) }}" autofocus required />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('nidn') ? 'border-danger' : '' }}"
                    id="nidn" name="nidn" placeholder="NIDN" value="{{ old('nidn', $kajur->nidn) }}" required />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('nip') ? 'border-danger' : '' }}"
                    id="nip" name="nip" placeholder="NIP" value="{{ old('nip', $kajur->nip) }}" required />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('gelar-depan') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('gelar-depan', $kajur->front_degree) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('gelar-belakang') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('gelar-belakang', $kajur->back_degree) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('jabatan') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('jabatan', $kajur->position) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('pangkat') ? 'border-danger' : '' }}"
                    id="pangkat" name="pangkat" placeholder="Pangkat" value="{{ old('pangkat', $kajur->rank) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {{ $errors->get('no-hp   ') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('no-hp', $kajur->phone_number) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control {{ $errors->get('email   ') ? 'border-danger' : '' }}"
                    ...
                    value="{{ old('email', $kajur->user->email) }}" />
                <x-input-error class="mt-2" :messages="$errors->get('email')" />
            </div>
            <div class="mb-3">
                <label for="foto" class="form-label">Foto</label>
                @if ($kajur->user->photo)
                    <img src="{{ $kajur->user->photoFile }}" alt="{{ $kajur->fullname }}"
